        ...
        <form action="">
          <div className="row max-sm:block">
            ...
            <div className="col max-sm:mt-2">
              ...
              <div>
                <input type="date" className="form-control w-[100%]" id="D-O-B" placeholder="D-O-B"/>
              </div>
            </div>
          </div>
          <div className="row max-sm:block mt-2">
            ...
            <div className="col max-sm:mt-2">
              ...
              <div>
                <input type="number" className="form-control w-[100%]" required id="Phone" placeholder="Phone"/>
              </div>
            </div>
          </div>
